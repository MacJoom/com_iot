 ...
 * @since  0.1.0
 */
class IotapiDataTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_iotapis.iotapi.data';
		...
		parent::__construct('#__iotapis_data', 'id', $db);
	}
	...
	protected function _getAssetName()
	{
		...
		return 'com_iotapis.iotapi.data' . (int) $this->$k;
	}
