...
namespace ITC\Component\Iotapis\Administrator\Table;
 ...
 * @since  0.1.0
 */
class IotapiTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_iotapis.iotapi';
		...
		parent::__construct('#__iotapis_details', 'id', $db);
	}
	...
	protected function _getAssetName()
	{
		...
		return 'com_iotapis.iotapi.' . (int) $this->$k;
	}
	...
	public function check()
	{
		...
		{
			$this->setError(Text::_('COM_IOTAPIS_WARNING_PROVIDE_VALID_NAME'));
	...
	public function store($updateNulls = true)
	{
		...
		$table     = $component->getMVCFactory()->createTable('Iotapi', 'Table', ['dbo' => $this->getDbo()]);
