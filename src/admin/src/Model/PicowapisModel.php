...
/**
 * Methods supporting a list of picowapi records.
 *
 * @since  0.1.0
 */
class PicowapisModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__picowapis_details', 'a'));
			...
			$subQuery = $db->getQuery(true)
				...
				->where(
					[
						...
						$db->quoteName('asso1.context') . ' = ' . $db->quote('com_picowapis.item'),
					]
				);
