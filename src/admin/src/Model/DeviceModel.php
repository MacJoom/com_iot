 ...
 * @since  0.1.0
 */
class DeviceModel extends AdminModel
{
	/**
	 ...
	 * @since  0.1.0
	 */
	public $typeAlias = 'com_iot.device';
	 ...
	 * @since  0.1.0
	 */
	protected $associationsContext = 'com_iot.item';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_iot.device', 'device', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$this->preprocessData('com_iot.device', $data);
	...
	public function getItem($pk = null)
	{
		...
		if ($assoc)
		{
			...
			if ($item->id != null)
			{
				$associations = Associations::getAssociations('com_iot', '#__iot_details', 'com_iot.item', $item->id, 'id', null);
		...
		if (Associations::isEnabled())
		{
			...
			if (count($languages) > 1)
			{
				...
				foreach ($languages as $language)
				{
					...
					$field->addAttribute('type', 'modal_iot');
